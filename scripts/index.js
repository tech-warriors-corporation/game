    ...
    next: function(){
        ...
        switch(this.step){
            case 1:
                life.reset();
                progress.reset();
                progress.setTitle('Ajude o rei Arthur a atravessar a ponte, complete a ponte com uma forma geométrica');
                home.show('Em busca da coroa', 'Jogar', './assets/images/home-arthur-and-merlin.png');
                this.changeBackgroundImage('./assets/images/bridge-wallpaper.png');
                cutscene
                    .show(
